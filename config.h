...
/* copyright info */
#define COPYRIGHT "Copyright (C) 2006-2016 Tiago de Paula Peixoto\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."

/* c++ preprocessor compilation options */
#define CPPFLAGS " -I/usr/include/python3.5m -I/usr/include -I/usr/lib/python3.5/site-packages/numpy/core/include"

/* c++ compilation options */
#define CXXFLAGS "-Wall -Wextra -ftemplate-backtrace-limit=0  -DNDEBUG -ftemplate-depth-250 -Wno-deprecated -Wno-unknown-pragmas -O3 -fvisibility=default -fvisibility-inlines-hidden -Wno-unknown-pragmas"
...
#define GIT_COMMIT "37996a0a"

/* git HEAD commit date */
#define GIT_COMMIT_DATE "Thu Jul 21 17:56:14 2016 +0200"
...
#define PACKAGE_STRING "graph-tool 2.18"
